<template>
  ...
  <div class="card mb-10">
    ...
    <div class="card-header card-header-stretch">
      ...
      >
        ...
        <li class="nav-item" v-if="config.layout.layoutConfig">
          <a
            class="nav-link"
          ...
          >
            <div class="row mb-10">
              ...
              <div class="col-lg-9 col-xl-4">
                <input type="hidden" v-model="config.layout.toolboxEnabled" />
                <input type="hidden" v-model="config.layout.layoutConfig" />
                <input type="hidden" v-model="config.layout.linksEnabled" />
                <input type="hidden" v-model="config.layout.notifications" />
                <input
                  type="hidden"
                  v-model="config.layout.quickActionsEnabled"
                />
                ...
                >
                  <input
                    ...
                    type="checkbox"
                    v-model="config.layout.toolboxEnabled"
                  />
                  <span class="form-check-label text-muted">Toolbox</span>
                </label>
                <label
                  class="form-check form-check-custom form-check-solid form-switch mb-5"
                >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    v-model="config.layout.layoutConfig"
                  />
                  <span class="form-check-label text-muted">Layout</span>
                </label>
                <label
                  class="form-check form-check-custom form-check-solid form-switch mb-5"
                >
                  <input
                    ...
                    v-model="config.layout.quickActionsEnabled"
                  />
                  <span class="form-check-label text-muted">Quick Actions</span>
                </label>
                <label
                  class="form-check form-check-custom form-check-solid form-switch mb-5"
                >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    v-model="config.layout.notifications"
                  />
                  <span class="form-check-label text-muted">Notifications</span>
                </label>
                <label
                  class="form-check form-check-custom form-check-solid form-switch mb-5"
                >
                  <input
                    class="form-check-input"
                    type="checkbox"
                    v-model="config.layout.linksEnabled"
                  />
                  <span class="form-check-label text-muted">Links</span>
                </label>

                <div class="form-text text-muted">Enable Template Toolbox.</div>
              </div>
            </div>
          </div>
          <div
            v-if="config.layout.layoutConfig"
            class="tab-pane"
            :class="{ active: tabIndex === 6 }"
            id="kt_builder_main"
          >
  ...
  <!--begin::Card-->
  <div class="card" v-if="config.layout.layoutConfig">
    <!--begin::Card Body-->
