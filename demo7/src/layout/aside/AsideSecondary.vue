    ...
    <div class="aside-workspace my-5 p-5" id="kt_aside_wordspace">
      <div class="d-flex h-100 flex-column">
          ...
          <div class="tab-content">
            ...
            >
              <div class="m-0">
                ...
                <div class="m-0">
                  <h1 class="text-gray-800 fw-bold mb-6 mx-5">
                    {{ translate("environments") }}
                  </h1>

                  <div
                    v-for="item in boxs.data.listBoxes.items"
                    v-bind:key="item.id"
                    class="mb-1 text-hover-primary bg-hover-light"
                    style="border-radius: 10px"
                  >
                    <a
                      :href="'#/box/units?id=' + item.id"
                      class="custom-list d-flex align-items-center px-5 py-4"
                    >
                      <div class="symbol symbol-40px me-5">
                        <span
                          class="symbol-label svg-icon svg-icon-2 svg-icon-gray-500"
                        >
                          <inline-svg
                            src="media/icons/duotune/technology/teh007.svg"
                          />
                        </span>
                      </div>
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        <h5
                          class="custom-list-title fw-bold text-gray-800 mb-1 text-hover-primary"
                        >
                          {{ item.name }}
                        </h5>
            ...
            <div
              v-if="true"
              class="tab-pane fade"
              id="kt_aside_nav_tab_cycles"
              role="tabpanel"
            >
              <CyclesMenu></CyclesMenu>
            </div>
            <div
              v-if="true"
              class="tab-pane fade"
        ...
        <div class="flex-column-auto pt-10 px-5" id="kt_aside_secondary_footer">
          ...
          >
            <span class="btn-label"> {{ translate("documentation") }} </span>
...
import CyclesMenu from "@/layout/aside/CyclesMenu.vue";
import AdminMenu from "@/layout/aside/AdminMenu.vue";
import StoreMenu from "@/layout/aside/StoreMenu.vue";
import ConfigMenu from "@/layout/aside/ConfigMenu.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    boxs = JSON.parse(localStorage.getItem("BOXS") || "{}");
