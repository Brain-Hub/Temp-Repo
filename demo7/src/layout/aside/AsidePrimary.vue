<template>
  ...
  >
    ...
    >
      <a href="#">
        <img alt="Logo" :src="config.main.logo.light" class="h-40px" />
      </a>
    </div>
      ...
      >
        <ul class="nav flex-column">
          <li
            ...
            title=""
            data-bs-original-title="Environments"
          >
            <a
            ...
            >
              <span class="svg-icon svg-icon-2x">
                <inline-svg src="media/icons/duotune/technology/teh007.svg" />
              </span>
            </a>
          </li>
          ...
          <li
            ...
            data-bs-dismiss="click"
            title=""
            data-bs-original-title="Cycles"
          >
            <a
              class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light"
              data-bs-toggle="tab"
              href="#kt_aside_nav_tab_cycles"
            >
              <span class="svg-icon svg-icon-2x">
                <inline-svg src="media/icons/duotune/technology/teh010.svg" />
              </span>
            </a>
          </li>
          ...
          <li
            ...
            data-bs-dismiss="click"
            title=""
            data-bs-original-title="Store"
          >
            <a
              class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light"
              data-bs-toggle="tab"
              href="#kt_aside_nav_tab_store"
            >
              <span class="svg-icon svg-icon-2x">
                <inline-svg src="media/icons/duotune/ecommerce/ecm004.svg" />
              </span>
            </a>
          </li>
          ...
          <li
            v-if="config.layout.toolboxEnabled"
            class="nav-item mb-2"
            data-bs-toggle="tooltip"
            data-bs-trigger="hover"
            data-bs-placement="right"
    ...
    >
      <div class="d-flex align-items-center mb-2">
        <div
          v-if="config.layout.linksEnabled"
      ...
      <div class="d-flex align-items-center mb-2">
        <div
          v-if="config.layout.notifications"
          class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light"
          data-kt-menu-trigger="click"
          data-kt-menu-overflow="true"
          data-kt-menu-placement="top-start"
      ...
      <div class="d-flex align-items-center mb-3">
        <div
          v-if="config.layout.quickActionsEnabled"
          class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light"
          data-kt-menu-trigger="click"
          data-kt-menu-overflow="true"
          data-kt-menu-placement="top-start"
