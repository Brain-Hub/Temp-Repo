 ...
 * @returns {boolean}
 */
export const toolboxEnabled = computed(() => {
  return store.getters.layoutConfig("layout.toolboxEnabled");
});
/**
 * Check if toolbox is enabled
 * @returns {boolean}
 */
export const layoutConfigEnabled = computed(() => {
  return store.getters.layoutConfig("layout.layoutConfig");
});
/**
